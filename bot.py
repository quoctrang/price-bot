...
def sync_products():
    print("Đang nạp danh sách sản phẩm kèm hình ảnh lên kho Supabase...")
    
    # Danh sách sản phẩm chuẩn có sẵn link hình ảnh thực tế
    sample_products = [
    ...
    for p in sample_products:
        save_to_supabase(p)
        time.sleep(0.2)
    print("Đã hoàn tất đồng bộ sản phẩm và hình ảnh!")
